# CLAUDE.md – ADVAY Social App Development Guide

This document provides guidance for working effectively in the ADVAY Social app codebase.

## Project Overview

ADVAY Social is a cross-platform social media application built with React Native and Expo. It runs on iOS, Android, and Web, connecting to the AT Protocol (atproto) decentralized social network.
...
function MyComponent() {
  ...
  return (
    <Text>
      <Trans>
        Welcome to <Text style={a.font_bold}>ADVAY</Text>, {name}!
      </Trans>
    </Text>
  )
}
