  ...
  return {
    expo: {
      ...
      ios: {
        ...
        bundleIdentifier: 'com.advay.app',
      ...
      plugins: [
        ...
        [
          'expo-splash-screen',
          {
            ios: {
              ...
              backgroundColor: '#FFFFFF', // ADVAY white background (light)
              image: './assets/splash/splash.png',
              resizeMode: 'cover',
              dark: {
                enableFullScreenImage_legacy: true, // iOS only
                backgroundColor: '#000000', // ADVAY logo's native black canvas (dark)
            ...
            android: {
              backgroundColor: '#FFFFFF', // ADVAY white background (light)
              image: './assets/splash/android-splash-logo.png',
              imageWidth: 160, // even division of 340px
              dark: {
                backgroundColor: '#000000', // ADVAY logo's native black canvas (dark)
                image: './assets/splash/android-splash-logo.png',
                imageWidth: 160,
        ...
        [
          ...
          {
            contactsPermission:
              'I agree to allow ADVAY to use my contacts for friend discovery until I opt out.',
          },
        ],
      ],
      extra: {
                ...
                appExtensions: [
                  {
                    ...
                    bundleIdentifier: 'com.advay.app.Share-with-Bluesky',
                    entitlements: {
                  ...
                  },
                  {
                    ...
                    bundleIdentifier: 'com.advay.app.BlueskyNSE',
                    entitlements: {
                      'com.apple.security.application-groups': [
                        'group.com.advay.app',
                      ],
                  ...
                  },
                  {
                    ...
                    bundleIdentifier: 'com.advay.app.AppClip',
                  },
                ],
              },
            },
