      ...
      case 'no matches header':
        return (
          <Header
            ...
            subtitleText={
              <Trans>
                ADVAY is more fun with friends. Do you want to invite some of
                yours?{' '}
                <InviteInfo
    ...
    <View style={[gutter, a.py_md, a.border_t, t.atoms.border_contrast_low]}>
      <ProfileCard.Header>
        ...
        {phoneNumber && currentAccount && (
          <Button
            label={_(msg`Invite ${name} to join ADVAY`)}
            color="secondary"
            size="small"
            onPress={async () => {
              ...
              try {
                await SMS.sendSMSAsync(
                  [phoneNumber],
                  _(
                    msg`I'm on ADVAY as ${currentAccount.handle} - come find me! https://bsky.app/download`,
                  ),
                )
              } catch (err) {
