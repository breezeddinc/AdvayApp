  ...
  const getJoinMessage = () => {
    ...
    if (isMe) {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`You joined ADVAY using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`You joined ADVAY ${timeAgoString} ago`)
      }
    } else {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`${profileName} joined ADVAY using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`${profileName} joined ADVAY ${timeAgoString} ago`)
      }
    }
  }
