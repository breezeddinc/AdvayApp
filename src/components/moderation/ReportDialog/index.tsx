...
function Inner(
  ...
  const supportedLabelers = useMemo(() => {
    ...
    return allLabelers
      ...
      .filter(l => {
        ...
        // all chat collections accepted, since only ADVAY handles chats
        if (
          props.subject.type === 'convoMessage' ||
          props.subject.type === 'convo'
        )
   ...
   * that labeler is ADVAY (which is the case for chat reports and certain
 ...
 * rendered once we have a position and the report is going to ADVAY.
 */
