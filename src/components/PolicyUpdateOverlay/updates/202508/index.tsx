...
export function Content({state}: {state: PolicyUpdateState}) {
  ...
  const links = {
    terms: {
      ...
      to: `https://advay.app/tos.html`,
      label: _(msg`Terms of Service`),
    },
    privacy: {
      overridePresentation: false,
      to: `https://advay.app/privacy.html`,
      ...
      <View style={[a.align_start, a.gap_xl]}>
        ...
        <View style={[a.w_full, a.gap_md]}>
          <Button
            ...
            accessibilityHint={_(
              msg`Tap to acknowledge that you understand and agree to these updates and continue using ADVAY`,
            )}
            color="primary"
            size="large"
            onPress={handleClose}>
