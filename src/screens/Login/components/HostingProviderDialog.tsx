 ...
 * "ADVAY" and a custom URL, the user chooses between "Automatic" (the PDS is
      ...
      <View style={[a.relative, a.gap_md, a.w_full]}>
            ...
            <Admonition type="tip">
              {isEmail ? (
                <Trans>
                  ...
                  so the default ADVAY service will be used. Enter your
        ...
        <View style={[a.py_xs]}>
          <Text
            ...
            <Trans>
              ADVAY is an open network where you can choose your hosting
