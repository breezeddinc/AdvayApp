    ...
    <View style={[a.flex_1]}>
      <Layout.Content ignoreTabletLayoutOffset>
        ...
        <View style={[a.gap_2xl, a.mx_lg, a.my_2xl]}>
          ...
          <View style={[a.gap_sm]}>
            <Button
              label={_(msg`Join ADVAY`)}
              onPress={onJoinPress}
              color="primary"
              size="large">
              <ButtonText style={[a.text_lg]}>
                <Trans>Join ADVAY</Trans>
              </ButtonText>
            </Button>
      ...
      <Prompt.Outer control={androidDialogControl}>
        <Prompt.Content>
          <Prompt.TitleText>
            <Trans>Download ADVAY</Trans>
          </Prompt.TitleText>
          <Prompt.DescriptionText>
            <Trans>
              The experience is better in the app. Download ADVAY now and
      ...
      {IS_WEB && (
        <meta
          ...
          content="app-id=com.advay.app, app-clip-bundle-id=com.advay.app.AppClip, app-clip-display=card"
        />
      )}
    </View>
  )
