                  ...
                  {isAARegion ? (
                    <>
                      <View style={[a.gap_lg]}>
                        ...
                        <Text style={[textStyles]}>
                          <Trans>
                            You are accessing ADVAY from a region that legally
                        ...
                        {!aa.flags.isOverRegionMinAccessAge && (
                          <Text style={[textStyles]}>
                            <Trans>
                              ...
                              you are not old enough to access ADVAY in your
                              region.
                            </Trans>
                          </Text>
                        )}
                    ...
                    <View style={[a.gap_lg]}>
                      <Text style={[textStyles]}>
                        <Trans>
                          ...
                          profile makes you too young to access ADVAY.
                        </Trans>
                      </Text>
      ...
      <View style={[a.gap_xl]}>
        {isBlocked ? (
          <Admonition type="warning">
            <Trans>
              You are currently unable to access ADVAY's Age Assurance flow.
              Please{' '}
              <SimpleInlineLinkText
