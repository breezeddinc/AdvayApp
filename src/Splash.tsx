...
export const Logo = forwardRef(function LogoImpl(
  props: {
    /**
     * Accepted for backwards compatibility with the existing call site, but
     * has no effect: the ADVAY mark is a fixed multi-color image and can't
     * be tinted with a single fill color the way the old vector mark could.
     */
    fill?: string
  ...
  return (
    <Image
      ...
      contentFit="contain"
      // @ts-ignore style type mismatch, fiiiiine
