...
export const webLinks = {
  // ADVAY's own terms — the app is a third-party client, not Bluesky itself
  tos: `https://advay.app/tos.html`,
  privacy: `https://advay.app/privacy.html`,
  // Content on ADVAY lives on the Bluesky network and is moderated under
  // Bluesky's own rules, so these intentionally still point to Bluesky.
