...
describe('toNiceDomain', () => {
  ...
  const outputs = ['example.com', 'bsky.app', 'ADVAY Social', '#123123123']
...
describe('createStarterPackGooglePlayUri', () => {
  const base =
    'https://play.google.com/store/apps/details?id=com.advay.app&referrer=utm_source%3Dbluesky%26utm_medium%3Dstarterpack%26utm_content%3Dstarterpack_'
