...
A collection of native utilities for the ADVAY Social app. This Expo module provides platform-specific functionality that is not available through standard React Native APIs.
...
Native key-value storage that persists across app restarts. Uses iOS App Groups (`group.com.advay.app`) for sharing data with extensions, and Android SharedPreferences.
...
- iOS uses App Group suite `group.com.advay.app` to share preferences with app extensions
- Android stores preferences in `com.advay.app`
...
ADVAY. Tapping it launches the app and triggers
...
Requires iOS 13.4 or later. Uses the App Group `group.com.advay.app` for SharedPrefs - ensure this is configured in your app's entitlements.
