...
A custom Expo module for managing shared notification preferences and handling background notifications in the ADVAY Social app. This module enables communication between the main app and notification service extensions through shared storage.
...
Uses iOS App Groups (`group.com.advay.app`) to share UserDefaults between the main app and the notification service extension. This allows the notification service extension to read preferences set by the main app without launching the app.
