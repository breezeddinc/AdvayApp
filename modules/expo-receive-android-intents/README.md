...
An Expo module that handles incoming Android intents for sharing text, images, and videos into the ADVAY app.

## What It Does

This module intercepts Android share intents (when a user shares content from another app to ADVAY) and converts them into deep links that the app can handle. It supports:
