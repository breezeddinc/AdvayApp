...
- **App Group**: `group.com.advay.app` allows data sharing between the main app and the extension
...
The extension requires the `group.com.advay.app` App Group to be configured in:
